...
st.set_page_config(
    page_title="Tether Price Prediction",
    page_icon="https://cryptologos.cc/logos/tether-usdt-logo.png?v=032"
)

st.title("Tether Predicted Price")
st.write("Welcome to our Tether Price Prediction page, where we leverage advanced machine learning models to forecast future prices of Tether. Utilizing historical data and sophisticated algorithms, we provide an interactive and visually engaging representation of predicted Tether prices.")

maindf = pd.read_csv('USDT-USD.csv')
...
fig = px.line(new_pred_plot, x=new_pred_plot.index, y=[new_pred_plot['last_original_days_value'],
              ...
              labels={'value': 'Tether price', 'index': 'Timestamp'})
